...
var imglist1=document.getElementById("sector4").getElementsByTagName('img');  
...
var imglist=document.getElementById("sector5").getElementsByTagName('img');  
for(var i=0;i<imglist.length;i++){	
		imglist[i].id="img0"+i+j;
		imglist[i].src="../images/loading.gif";  
